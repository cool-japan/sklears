//! Matrix-based imputation methods
//!
//! This module contains imputation methods based on matrix factorization
...
/// Simple linear system solver using Gaussian elimination with partial pivoting
...
impl Fit<ArrayView2<'_, Float>, ()> for MatrixFactorizationImputer<Untrained> {
    ...
    fn fit(self, X: &ArrayView2<'_, Float>, _y: &()) -> SklResult<Self::Fitted> {
        ...
        let mut rng = if let Some(seed) = self.random_state {
            ...
            rand::rngs::StdRng::seed_from_u64(thread_Random::default().gen())
        };
