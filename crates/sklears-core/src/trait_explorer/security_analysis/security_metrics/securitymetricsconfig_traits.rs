...
impl Default for SecurityMetricsConfig {
    fn default() -> Self {
        ...
        collection_intervals
            .insert(MetricType::Vulnerability, Duration::from_secs(3600));
        ...
        retention_policies
            .insert(MetricType::Vulnerability, Duration::from_secs(86400 * 365));
        ...
        retention_policies
            .insert(MetricType::Compliance, Duration::from_secs(86400 * 2555));
        retention_policies
            .insert(MetricType::Performance, Duration::from_secs(86400 * 90));
        retention_policies
            .insert(MetricType::Operational, Duration::from_secs(86400 * 365));
