...
```toml
[dependencies]
sklears = { version = "0.1.0-alpha.1", features = ["linear", "ensemble", "gpu"] }
```
...
- Serves as the umbrella crate validated through the 10,013 passing workspace tests for `0.1.0-alpha.1`.
