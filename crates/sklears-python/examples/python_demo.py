...
def demo_linear_regression():
    ...
    # Calculate metrics
    sklears_mse = mean_squared_error(y_test, sklears_predictions)
    sklears_r2 = model.score(X_test, y_test)
    
    print(f"Sklears - Time: {sklears_time:.4f}s, MSE: {sklears_mse:.4f}, R²: {sklears_r2:.4f}")
    ...
    try:
        ...
        print(f"Sklearn - Time: {sklearn_time:.4f}s, MSE: {sklearn_mse:.4f}, R²: {sklearn_r2:.4f}")
