//! Label Spreading algorithm implementation
...
///
/// Label spreading is similar to label propagation but uses a different
/// normalization of the graph Laplacian and includes a regularization parameter.
///
/// # Parameters
///
...
/// ```
#[derive(Debug, Clone)]
pub struct LabelSpreading<S = Untrained> {
    state: S,
    kernel: String,
    gamma: f64,
    n_neighbors: usize,
...
impl LabelSpreading<Untrained> {
    /// Create a new LabelSpreading instance
    pub fn new() -> Self {
        Self {
            state: Untrained,
            kernel: "rbf".to_string(),
...
impl Default for LabelSpreading<Untrained> {
    fn default() -> Self {
        Self::new()
    }
}

impl Estimator for LabelSpreading<Untrained> {
    type Config = ();
...
impl Fit<ArrayView2<'_, Float>, ArrayView1<'_, i32>> for LabelSpreading<Untrained> {
    type Fitted = LabelSpreading<LabelSpreadingTrained>;
    ...
    fn fit(self, X: &ArrayView2<'_, Float>, y: &ArrayView1<'_, i32>) -> SklResult<Self::Fitted> {
        ...
        for _iter in 0..self.max_iter {
            // Update: Y = alpha * S * Y + (1 - alpha) * Y_static
...
impl Predict<ArrayView2<'_, Float>, Array1<i32>> for LabelSpreading<LabelSpreadingTrained> {
    #[allow(non_snake_case)]
...
impl PredictProba<ArrayView2<'_, Float>, Array2<f64>> for LabelSpreading<LabelSpreadingTrained> {
    #[allow(non_snake_case)]
...
#[derive(Debug, Clone)]
pub struct LabelSpreadingTrained {
    /// X_train
